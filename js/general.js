...
$(document).ready(function(){
	...
	*************************************************/
	...
	#############################################################
	########                                             ########
	########         min DESKTOP-LARGE VERSION          ########
	########                                             ########
	#############################################################
	#############################################################  
	############################################################*/

	let mql_minDesktopLarge = window.matchMedia ("(min-width: 75em)"); 
	screenTest3(mql_minDesktopLarge);
	mql_minDesktopLarge.addListener(screenTest3);

	function screenTest3(e) {
		if (e.matches) {
			...
			--> .container-mainImage
				-- change height; height ~ width (if with > height)
			=========================================================*/	
			// let elmMainImage = document.querySelector(".component-aboutUs .container-mainImage");
			// widthOfMainImage = elmMainImage.offsetWidth;
			// let heightOfMainImage = elmMainImage.offsetHeight;
			

			// if (heightOfMainImage < widthOfMainImage) {
			// 	elmMainImage.style.height = widthOfMainImage + "px";			
			// }
		...
		//######################################################	
			...
			--> .container-mainImage
				-- undo changed-height; height = which is set in _z2_tablet.scss
			=========================================================*/	
